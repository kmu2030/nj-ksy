...
types:
  ...
  union_struct:
    seq:
      - id: struct_begin
        type: nj::struct_begin('union_struct', 8)

      # fields
      - id: alignment1_unions
        type: alignment1_union_t::alignment1_union_array_1d(2) 
      - id: alignment2_unions
        type: alignment2_union_t::alignment2_union_array_1d(2) 
      - id: a_alignment4_union
        type: alignment4_union_t::alignment4_union
      - id: a_alignment8_union
        type: alignment8_union_t::alignment8_union 
  ...
  union_struct_array_3d:
    ...
    seq:
      - id: v
        repeat: expr
        repeat-expr: z + 0
        type: union_struct_array_2d(y, x)
    instances:
      alignment:
        value: v[0].alignment
      padding:
