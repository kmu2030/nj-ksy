...
types:
  ...
  nest1_struct:
    seq:
      - id: struct_begin
        type: nj::struct_begin('nest1_struct', 2)
  ...
  nest1_struct_array_3d:
    ...
    seq:
      - id: v
        repeat: expr
        repeat-expr: z + 0
        type: nest1_struct_array_2d(y, x)
    instances:
      alignment:
        value: v[0].alignment
      padding:
