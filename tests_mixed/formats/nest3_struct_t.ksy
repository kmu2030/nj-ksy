...
types:
  ...
  nest3_struct:
    seq:
      - id: struct_begin
        type: nj::struct_begin('nest3_struct', 8)

      # fields
      - id: a_nest2_struct
        type: nest2_struct_t::nest2_struct
      - id: a_small_struct
  ...
  nest3_struct_array_3d:
    ...
    seq:
      - id: v
        repeat: expr
        repeat-expr: z + 0
        type: nest3_struct_array_2d(y, x)
    instances:
      alignment:
        value: v[0].alignment
      padding:
