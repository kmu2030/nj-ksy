...
types:
  ...
  alignment8_struct:
    seq:
      - id: struct_begin
        type: nj::struct_begin('alignment8_struct', 8)
      ...
      - id: a_lint
        type: nj::lint
      - id: udints
        type: nj::udint_array_1d(2)
      - id: a_alignment2_struct
        type: alignment2_struct_t::alignment2_struct
  ...
  alignment8_struct_array_2d:
    ...
    seq:
      - id: v
        repeat: expr
        repeat-expr: y + 0
        type: alignment8_struct_array_1d(x)
    instances:
      alignment:
        value: v[0].alignment
      padding:
  ...
  alignment8_struct_array_3d:
    ...
    seq:
      - id: v
        repeat: expr
        repeat-expr: z + 0
        type: alignment8_struct_array_2d(y, x)
    instances:
      alignment:
        value: v[0].alignment
      padding:
