...
types:
  ...
  padded_struct:
    seq:
      - id: struct_begin
        type: nj::struct_begin('padded_struct', 8)
  ...
  padded_struct_array_3d:
    ...
    seq:
      - id: v
        repeat: expr
        repeat-expr: z + 0
        type: padded_struct_array_2d(y, x)
    instances:
      alignment:
        value: v[0].alignment
      padding:
